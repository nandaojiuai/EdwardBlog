...
import people from '../../assets/uppeople/people.png'
import gift from '../../assets/uppeople/gift.png'
import coin1 from '../../assets/uppeople/coin1.png'
import coin2 from '../../assets/uppeople/coin2.png'
import coin3 from '../../assets/uppeople/coin3.png'
import coin4 from '../../assets/uppeople/coin4.png'
import coin5 from '../../assets/uppeople/coin5.png'
import coin6 from '../../assets/uppeople/coin6.png'
import coin7 from '../../assets/uppeople/coin7.png'
...
// 获取椭圆旋转并平移后的坐标位置
function getEllipseTransitionPos(x: number, y: number, rotate = 0, transformX = 0, transformY = 0) {
  let transitionX = x
  let transitionY = y
  if (rotate !== 0) {
...
const loop = () => {
  if (contentRef.value) {
    ...
    const nextData = getEllipseNextPos(a, b, direction, toOX, toOY, newSpeed)
    ...
    if (giftBox) {
      Object.keys(iconData).forEach((key, index) => {
        const elm = (giftBox as HTMLImageElement).childNodes[index] as HTMLElement
        if (elm) {
          // @ts-ignore
